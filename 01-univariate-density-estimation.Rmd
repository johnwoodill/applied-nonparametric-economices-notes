...
$$min_k(\Psi) : AMISE[\hat{f}(x)] \text{s.t.} K_{0}(k) = 1; K_1 (K) = 0; K_2 (k) < \infty$$
...
$$h_{opt} = [\frac{f(x)R(k)}{k_2^2(k) f^2 (x)^2}]^{1/5} n^{-1/5}$$
...
$$\check{h}=[\frac{(-1)^{r/2}2k^{(2r)}(0)}{k_{2}(k)R(f^{(2r+2)})n}]^{1/(2r+2+1)}$$
